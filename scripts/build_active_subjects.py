...
SUBJ_1BTL = {
    ...
    "info_grid": [
        ...
        {"label": {"es":"Bloques","ca":"Blocs","en":"Blocks"}, "value":"6"},
    ],
    "year_current": "2025–26",
    "materia_filter": "bach-ccss-1",
    "units": [
        {"num":"01","slug":"reales","title":"Números reales · matemática financiera",
         "desc_l":{"es":"Número real, intervalos, capitalización simple y compuesta, TAE.",
                   "ca":"Nombre real, intervals, capitalització simple i composta, TAE.",
                   "en":"Real numbers, intervals, simple and compound interest, APR."}},
        {"num":"02","slug":"algebra","title":"Álgebra · ecuaciones, inecuaciones y sistemas",
         "desc_l":{"es":"Polinomios, ecuaciones, inecuaciones y sistemas lineales y no lineales.",
                   "ca":"Polinomis, equacions, inequacions i sistemes lineals i no lineals.",
                   "en":"Polynomials, equations, inequalities and linear/non-linear systems."}},
        {"num":"03","slug":"funciones","title":"Funciones elementales y modelización",
         "desc_l":{"es":"Funciones lineales, polinómicas, racionales, exponenciales, logarítmicas y a trozos.",
                   "ca":"Funcions lineals, polinòmiques, racionals, exponencials, logarítmiques i a trossos.",
                   "en":"Linear, polynomial, rational, exponential, logarithmic and piecewise functions."}},
        {"num":"04","slug":"derivadas","title":"Límites, continuidad y derivadas",
         "desc_l":{"es":"Concepto de límite, continuidad, derivadas y aplicaciones al estudio de funciones.",
                   "ca":"Concepte de límit, continuïtat, derivades i aplicacions a l'estudi de funcions.",
                   "en":"Limit concept, continuity, derivatives and applications to function analysis."}},
        {"num":"05","slug":"estadistica","title":"Estadística descriptiva bidimensional",
         "desc_l":{"es":"Distribuciones bidimensionales, correlación y regresión lineal.",
                   "ca":"Distribucions bidimensionals, correlació i regressió lineal.",
                   "en":"Two-dimensional distributions, correlation and linear regression."}},
        {"num":"06","slug":"probabilidad","title":"Probabilidad y distribuciones",
         "desc_l":{"es":"Probabilidad condicionada, distribución binomial y normal.",
                   "ca":"Probabilitat condicionada, distribució binomial i normal.",
                   "en":"Conditional probability, binomial and normal distributions."}},
    ],
}
