...
<nav>
  <div class="nav-inner">
    ...
    <div class="nav-right">
      <div class="lang-sw">
        <a href="{col['url_index']}" class="lang-active">ES</a><span class="lang-sep">&middot;</span><a href="/ca{col['url_index']}">CA</a><span class="lang-sep">&middot;</span><a href="/en{col['url_index']}">EN</a>
      </div>
